...
<?php 
print($states[filter_budget_min]); 
?>
...
<?php endif ?>
  ...
  <p>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        jQuery(document).ready(function(){
            <?php if ($searchcontext === true): ?>
                jQuery("#Slider_Budget").slider("value",<?php echo $states[filter_budget_min] ?>,<?php echo $states[filter_budget_max] ?>);
            <?php endif ?>
        });
  </script>
